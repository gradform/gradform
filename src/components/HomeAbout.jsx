    ...
    <section id="about" className="w-full py-20 flex justify-center items-center">
      <div className="container mx-auto px-4">
        <MagicBento glowColor="0, 0, 205"> {/* Medium Blue */}
          <h2 className="text-3xl font-bricolage-24pt font-semibold mb-6 text-white text-left">What is Gradform?</h2>
          ...
          <p className="text-lg text-blue-100 leading-relaxed mt-4 text-left">
