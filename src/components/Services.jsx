    ...
    <section id="services" className="min-h-screen flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-5xl">
        ...
        <div className="mt-8 flex justify-center">
          <a href="/services-page" className="bg-white text-[#0000CD] px-6 py-3 rounded-xl hover:bg-blue-100 hover:shadow-2xl hover:shadow-[#0000CD]/70 transition-all duration-300 text-sm font-medium drop-shadow-lg font-inter min-w-[180px] flex justify-center items-center">Find Out More</a>
        </div>
      </div>
    </section>
  );
