...
import Ribbons from './components/Ribbons'; // Import Ribbons
...
const ServicesPage = () => {
  return (
    <div className="bg-linear-to-r from-[#0000CD] via-[#0000B0] to-[#4B0082] text-white min-h-screen flex flex-col">
      <Header />
      <Ribbons /> {/* Added Ribbons component */}
      <main className="grow container mx-auto px-0 py-20"> {/* Removed horizontal padding */}
          ...
          <div className={cn(
            ...
            <div className="relative z-10 p-4 flex flex-col md:flex-row items-center justify-center md:space-x-12 w-full">
              ...
              <div className="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-0 md:translate-x-[10%]">
                ...
                <a href="#explore-services" className="mt-8 inline-block bg-white text-[#0000CD] px-8 py-3 rounded-xl hover:bg-blue-100 hover:shadow-2xl hover:shadow-[#0000CD]/70 transition-all duration-300 text-base font-medium drop-shadow-lg font-inter animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
                  View All Services
                </a>
              </div>
